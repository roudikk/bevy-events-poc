...
struct Images {
    bevy_icon: AssetId<Image>,
    bevy_icon_inverted: AssetId<Image>,
}
...
impl FromWorld for Images {
    fn from_world(world: &mut World) -> Self {
        ...
        Self {
            bevy_icon: asset_server.load("icon.png").id(),
            bevy_icon_inverted: asset_server.load("icon_inverted.png").id(),
        }
    }
}
