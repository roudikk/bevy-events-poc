...
use bevy_render::{
    ...
    render_resource::{
        ...
        BufferUsages, CachedRenderPipelineId, DynamicUniformBuffer, PipelineCache, ShaderType,
...
pub fn queue_pipelines_system(
    ...
    let pipelines: HashMap<MainEntity, CachedRenderPipelineId> = egui_views
        ...
        .filter_map(|egui_camera_view| {
            let (main_entity, extracted_camera) = camera_views.get_some(egui_camera_view.0).ok()?;
